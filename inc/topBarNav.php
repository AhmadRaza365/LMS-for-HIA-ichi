      ...
      <nav class="main-header navbar navbar-expand-md navbar-dark navbar-white PrimaryBg">
      <div class="container">
        <a href="<?php echo base_url ?>" class="navbar-brand">
          ...
          <span class="brand-text font-weight-light tertiaryColor">HIA-ichi LMS</span>
        </a>
