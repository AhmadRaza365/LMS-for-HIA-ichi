	...
	<div class="card card-outline SecondaryColBorder card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat SecondaryBg tertiaryColor new_student" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
					...
					?>
						<tr>
							...
							<td class="text-center">
								<div class="btn-group">
									<button type="button" class="btn btn-default btn-block btn-flat dropdown-toggle SecondaryBg tertiaryColor dropdown-hover dropdown-icon btn-sm" data-toggle="dropdown" aria-expanded="false">
										Action
